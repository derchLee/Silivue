...
final class HistoryChartAggregationTests: XCTestCase {
    ...
    func testAggregationSortsBucketsChronologically() {
        let base = Date(timeIntervalSince1970: 1_800)
        let points = [
            HistoryChartView24h.ChartDataPoint(timestamp: base.addingTimeInterval(35), value: 2),
            HistoryChartView24h.ChartDataPoint(timestamp: base.addingTimeInterval(5), value: 1)
        ]
